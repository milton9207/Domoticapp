package com.example.domoticapp.app.Activities.Initial;
...
import com.example.domoticapp.app.Activities.MainActivity;
import com.example.domoticapp.app.R;

import com.example.domoticapp.app.Adapters.AccessPointListAdapter;
import com.example.domoticapp.app.data.HueSharedPreferences;
 ...
 *
 * For first time use, a Bridge search (UPNP) is performed and a list of all
 * available bridges is displayed (and clicking one of them shows the PushLink
 * dialog allowing authentication).
 ...
 * When connected the MyApplicationActivity Activity is started.
...
public class PHHomeActivity extends Activity implements OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phHueSDK.setAppName("DomoticApp");
        ...
        // For first time use this will be empty so a bridge search is automatically started.
        ...
        if (lastIpAddress !=null && !lastIpAddress.equals("")) {
            ...
            Log.d(TAG,"not first time opened app " + lastIpAddress + " " + lastUsername);
    ...
    public void onDestroy() {
        super.onDestroy();
        if (listener !=null) {
            Log.d(TAG,"onDestroy listener not nll");
